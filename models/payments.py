...
class PaymentStatus(Enum):
    ...
    PAYMENT_AUTHORIZED = 'payment_authorized'  # Funds held but not yet captured
    PAYMENT_CAPTURE_PENDING = 'payment_capture_pending'  # Ready to capture
    PAYMENT_CAPTURED = 'payment_captured'  # Funds successfully captured
